...

{
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona cases reported in February, March, 2020", x = "Date(2020)", y = "Cases",) + theme_light()
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona deaths reported in February, March, 2020", x = "Date(2020)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona cases reported in March, 2020", x = "Date(2020)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona deaths reported in March, 2020", x = "Date(2020)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona cases reported in April, 2020", x = "Date(2020)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona deaths reported in April, 2020", x = "Date(2020)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona cases reported in June, 2020", x = "Date(2020)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "Corona deaths reported in June, 2020", x = "Date(2020)", y = "Deaths")
...

{
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_cases_ThangHai, col = "blueviolet") +
    labs(title = "Corona cases reported in February, March, 2021", x = "Date(2021)", y = "Cases",) + theme_light()
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_deaths_ThangHai, col = "chocolate1") +
    labs(title = "Corona deaths reported in February, March, 2021", x = "Date(2021)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangBa <- ggplot(NULL, aes(x = thangBa_Cacngay, y = thangBa_7Ngay)) + geom_line(data = new_cases_ThangBa, col = "blueviolet") +
    labs(title = "Corona cases reported in March, 2021", x = "Date(2021)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangBa <- ggplot(NULL, aes(x = thangBa_Cacngay, y = thangBa_7Ngay)) + geom_line(data = new_deaths_ThangBa, col = "chocolate2") +
    labs(title = "Corona deaths reported in March, 2021", x = "Date(2021)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangTu <- ggplot(NULL, aes(x = thangTu_Cacngay, y = thangTu_7Ngay)) + geom_line(data = new_cases_ThangTu, col = "blueviolet") +
    labs(title = "Corona cases reported in April, 2021", x = "Date(2021)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangTu <- ggplot(NULL, aes(x = thangTu_Cacngay, y = thangTu_7Ngay)) + geom_line(data = new_deaths_ThangTu, col = "chocolate3") +
    labs(title = "Corona deaths reported in April, 2021", x = "Date(2021)", y = "Deaths")
}

{
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangSau <- ggplot(NULL, aes(x = thangSau_Cacngay, y = thangSau_7Ngay)) + geom_line(data = new_cases_ThangSau, col = "blueviolet") +
    labs(title = "Corona cases reported in June, 2021", x = "Date(2021)", y = "Cases")
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangSau <- ggplot(NULL, aes(x = thangSau_Cacngay, y = thangSau_7Ngay)) + geom_line(data = new_deaths_ThangSau, col = "chocolate") +
    labs(title = "Corona deaths reported in June, 2021", x = "Date(2021)", y = "Deaths")
...

{
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_cases_ThangHai, col = "blueviolet") +
    labs(title = "Corona cases reported in February, March, 2022", x = "Date(2022)", y = "Cases",) + theme_light()
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_deaths_ThangHai, col = "chocolate1") +
    labs(title = "Corona deaths reported in February, March, 2022", x = "Date(2022)", y = "Deaths")
