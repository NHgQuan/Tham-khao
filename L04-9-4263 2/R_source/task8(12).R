...

{
  ...
  thangHai_Cacngay <- seq(as.Date("2020-2-1"), as.Date("2020-2-29"), by = "days")#Danh sách các ngày trong tháng Hai
  ...
  for (i in 1 : x)
  {
    ...
    new_cases_ThangHai <- data.frame(thangHai_7Ngay, thangHai_Cacngay)
    ...
    labs(title = "COVID-19 cases reported in February, 2020", x = "Date(2/2020)", y = "Cases (Average in last 7 days)")

  #New deaths, thangHai, Year 2020
  dayCountHai <- 0
  thangHai <- {}
  thangHai_7Ngay <- {}
  thangHai_Cacngay <- seq(as.Date("2020-2-1"), as.Date("2020-2-29"), by = "days")
  #Year 2020
  curYear <- 2020
  curMonth <- 2
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 deaths reported in February, 2020", x = "Date(2/2020)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangBa_Cacngay <- seq(as.Date("2020-3-1"), as.Date("2020-3-31"), by = "days") #Danh sách các ngày trong tháng Ba
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 cases reported in March, 2020", x = "Date(3/2020)", y = "Cases (Average in last 7 days)")

  #New deaths, thangBa, Year 2020
  dayCountBa <- 0
  thangBa <- {}
  thangBa_7Ngay <- {}
  thangBa_Cacngay <- seq(as.Date("2020-3-1"), as.Date("2020-3-31"), by = "days")
  #Year 2020
  curYear <- 2020
  curMonth <- 3
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 deaths reported in March, 2020", x = "Date(3/2020)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangTu_Cacngay <- seq(as.Date("2020-4-1"), as.Date("2020-4-30"), by = "days") #Danh sách các ngày trong tháng Tu
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 cases reported in April, 2020", x = "Date(4/2020)", y = "Cases (Average in last 7 days)")

  #New deaths, thangTu, Year 2020
  dayCountTu <- 0
  thangTu <- {}
  thangTu_7Ngay <- {}
  thangTu_Cacngay <- seq(as.Date("2020-4-1"), as.Date("2020-4-30"), by = "days")
  #Year 2020
  curYear <- 2020
  curMonth <- 4
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 deaths reported in April, 2020", x = "Date(4/2020)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangSau_Cacngay <- seq(as.Date("2020-6-1"), as.Date("2020-6-30"), by = "days")
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 cases reported in June, 2020", x = "Date(6/2020)", y = "Cases (Average in last 7 days)")
  ...
  for (i in 1 : x)
  {
    ...
    labs(title = "COVID-19 deaths reported in June, 2020", x = "Date(6/2020)", y = "Deaths (Average in last 7 days)")
    ggsave( filename = "task8_subtask1_case_2020.pdf",
            ...
            units = c("in"),
            dpi = 300)
    ggsave( filename = "task8_subtask2_death_2020.pdf",
...

{
  ...
  thangHai <- {}            #Tổng các dữ liệu từ ngày 1 tháng Hai tới ngày i
  thangHai_7Ngay <- {}      #dữ liệu trung bình trong 7 ngày gần nhất
  thangHai_Cacngay <- seq(as.Date("2021-2-1"), as.Date("2021-2-28"), by = "days")#Danh sách các ngày trong tháng Hai
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_cases_ThangHai, col = "blue") +
    labs(title = "COVID-19 cases reported in February, 2021", x = "Date(2/2021)", y = "Cases (Average in last 7 days)")

  #New deaths, thangHai, Year 2021
  dayCountHai <- 0
  thangHai <- {}
  thangHai_7Ngay <- {}
  thangHai_Cacngay <- seq(as.Date("2021-2-1"), as.Date("2021-2-28"), by = "days")
  #Year 2021
  curYear <- 2021
  curMonth <- 2
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_deaths_ThangHai, col = "red") +
    labs(title = "COVID-19 deaths reported in February, 2021", x = "Date(2/2021)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangBa <- {}            #Tổng các dữ liệu từ ngày 1 tháng Ba tới ngày i
  thangBa_7Ngay <- {}      #dữ liệu trung bình trong 7 ngày gần nhất
  thangBa_Cacngay <- seq(as.Date("2021-3-1"), as.Date("2021-3-31"), by = "days")#Danh sách các ngày trong tháng Ba
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangBa <- ggplot(NULL, aes(x = thangBa_Cacngay, y = thangBa_7Ngay)) + geom_line(data = new_cases_ThangBa, col = "blue") +
    labs(title = "COVID-19 cases reported in March, 2021", x = "Date(3/2021)", y = "Cases (Average in last 7 days)")

  #New deaths, thangBa, Year 2021
  dayCountBa <- 0
  thangBa <- {}
  thangBa_7Ngay <- {}
  thangBa_Cacngay <- seq(as.Date("2021-3-1"), as.Date("2021-3-31"), by = "days")
  #Year 2021
  curYear <- 2021
  curMonth <- 3
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangBa <- ggplot(NULL, aes(x = thangBa_Cacngay, y = thangBa_7Ngay)) + geom_line(data = new_deaths_ThangBa, col = "red") +
    labs(title = "COVID-19 deaths reported in March, 2021", x = "Date(3/2021)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangTu <- {}            #Tổng các dữ liệu từ ngày 1 tháng Tu tới ngày i
  thangTu_7Ngay <- {}      #dữ liệu trung bình trong 7 ngày gần nhất
  thangTu_Cacngay <- seq(as.Date("2021-4-1"), as.Date("2021-4-30"), by = "days")#Danh sách các ngày trong tháng Tu
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangTu <- ggplot(NULL, aes(x = thangTu_Cacngay, y = thangTu_7Ngay)) + geom_line(data = new_cases_ThangTu, col = "blue") +
    labs(title = "COVID-19 cases reported in April, 2021", x = "Date(4/2021)", y = "Cases (Average in last 7 days)")

  #New deaths, thangTu, Year 2021
  dayCountTu <- 0
  thangTu <- {}
  thangTu_7Ngay <- {}
  thangTu_Cacngay <- seq(as.Date("2021-4-1"), as.Date("2021-4-30"), by = "days")
  #Year 2021
  curYear <- 2021
  curMonth <- 4
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangTu <- ggplot(NULL, aes(x = thangTu_Cacngay, y = thangTu_7Ngay)) + geom_line(data = new_deaths_ThangTu, col = "red") +
    labs(title = "COVID-19 deaths reported in April, 2021", x = "Date(4/2021)", y = "Deaths (Average in last 7 days)")
}

{
  ...
  thangSau <- {}            #Tổng các dữ liệu từ ngày 1 tháng Sau tới ngày i
  thangSau_7Ngay <- {}      #dữ liệu trung bình trong 7 ngày gần nhất
  thangSau_Cacngay <- seq(as.Date("2021-6-1"), as.Date("2021-6-30"), by = "days")#Danh sách các ngày trong tháng Sau
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangSau <- ggplot(NULL, aes(x = thangSau_Cacngay, y = thangSau_7Ngay)) + geom_line(data = new_cases_ThangSau, col = "blue") +
    labs(title = "COVID-19 cases reported in June, 2021", x = "Date(6/2021)", y = "Cases (Average in last 7 days)")

  #New deaths, thangSau, Year 2021
  dayCountSau <- 0
  thangSau <- {}
  thangSau_7Ngay <- {}
  thangSau_Cacngay <- seq(as.Date("2021-6-1"), as.Date("2021-6-30"), by = "days")
  #Year 2021
  curYear <- 2021
  curMonth <- 6
  for (i in 1 : x)
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_deaths_thangSau <- ggplot(NULL, aes(x = thangSau_Cacngay, y = thangSau_7Ngay)) + geom_line(data = new_deaths_ThangSau, col = "red") +
    labs(title = "COVID-19 deaths reported in June, 2021", x = "Date(6/2021)", y = "Deaths (Average in last 7 days)")
    ggsave( filename = "task8_subtask1_case_2021.pdf",
            plot = ggarrange(graph_cases_thangHai, graph_cases_thangBa, graph_cases_thangTu, graph_cases_thangSau, nrow = 4, ncol = 1, common.legend = TRUE),
            scale = 1,
            width = 10,
            height = 25,
            units = c("in"),
            dpi = 300)
    ggsave( filename = "task8_subtask2_death_2021.pdf",
            plot = ggarrange(graph_deaths_thangHai, graph_deaths_thangBa, graph_deaths_thangTu, graph_deaths_thangSau, nrow = 4, ncol = 1, common.legend = TRUE),
            scale = 1,
            width = 10,
            height = 25,
  ...
  thangHai <- {}
  thangHai_7Ngay <- {}
  thangHai_Cacngay <- seq(as.Date("2021-2-1"), as.Date("2021-2-19"), by = "days")
  curYear <- 2022
  curMonth <- 2
  ...
  for (i in 1 : x)
  {
    ...
    #Tạo biểu đồ lưu vào biến
    graph_cases_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_cases_ThangHai, col = "blue") +
    labs(title = "COVID-19 cases reported in February, 2022", x = "Date(2/2022)", y = "Cases (Average in last 7 days)")
...
#New deaths, thangHai, Year 2022
{
  ...
  #Tạo biểu đồ lưu vào biến
  graph_deaths_thangHai <- ggplot(NULL, aes(x = thangHai_Cacngay, y = thangHai_7Ngay)) + geom_line(data = new_deaths_ThangHai, col = "blue") +
  labs(title = "COVID-19 deaths reported in February, 2022", x = "Date(2/2022)", y = "Deaths (Average in last 7 days)") 
  #Vẽ biểu đồ
    ggsave( filename = "task8_subtask1_case_2022.pdf",
            plot = ggarrange(graph_cases_thangHai, nrow = 1, ncol = 1, common.legend = TRUE),
            scale = 1,
            units = c("in"),
            dpi = 300)
    ggsave( filename = "task8_subtask2_death_2022.pdf",
